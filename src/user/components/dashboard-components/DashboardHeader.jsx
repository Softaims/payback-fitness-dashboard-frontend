...
import customToast from "../../../user/lib/toast";
import {
  getUserInitials,
  getUserDisplayName,
} from "../../utils/getUserinitials";
import { clearTokens } from "../../../user/lib/tokenUtils";
...
const DashboardHeader = ({ onMenuClick }) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 h-16 bg-[#0f1c16] flex items-center justify-between px-6 border-b border-[#ffffff]/7 z-100">
      <div className="flex items-center gap-1">
        ...
        <div className="flex items-center gap-1">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-1">
              <span className="text-[#4BEEA2] font-bold text-lg tracking-[0.1em]">
                Pay
              </span>
              <span className="text-white font-bold text-lg tracking-[0.1em]">
                Back
              </span>
            </div>
            <span className="text-[#ffffff]/50 text-xs tracking-[0.6em]">
              Fitness
            </span>
          </div>
        </div>
      ...
      <div className="relative" ref={dropdownRef}>
        <div
          className="flex items-center gap-2 cursor-pointer hover:bg-[#ffffff]/10 px-3 py-2 rounded-md transition-colors"
            ...
            <div className="p-4 border-b border-[#ffffff]/10">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-[#ffffff]/50 text-xs break-all">
                    {user?.email}
                  </p>
                </div>
              </div>
