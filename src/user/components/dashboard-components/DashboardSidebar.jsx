...
const SidebarItem = ({
  ...
  const baseClasses =
    "text-xs flex items-center gap-1 px-4 py-2 rounded-md transition-colors duration-200";
    ...
    return (
      <li>
        <a
          ...
          className={`cursor-pointer  ${baseClasses} ${itemClasses}`}
          onClick={onClick}
        >
          <span className={iconClasses}>
            <Icon className="ml-[3px] w-5 h-5 text-[#ffffff]/50" />{" "}
            {/* size optional */}
          </span>
    ...
    <>
      ...
      >
        ...
        <div className="mt-8 flex-1 px-2 pt-6 min-h-0 overflow-y-auto">
          <h3 className="text-[#ffffff]/50 text-xs font-semibold uppercase tracking-wider mb-4 px-4">
            Menu
          </h3>
