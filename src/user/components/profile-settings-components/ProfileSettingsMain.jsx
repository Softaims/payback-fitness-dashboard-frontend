      ...
      <div className="space-y-8">
        ...
        <div className="bg-[#ffffff]/7 rounded-xl p-6">
          ...
          <p className="text-[#ffffff]/50 text-sm mb-6 leading-relaxed">
            ...
            data. Any remaining PF Points will be forfeited and cannot be
            recovered. If you have an active subscription or are part of a
            group, your account will only be deleted after those are completed.
          </p>
          <button
            onClick={handleDeleteAccount}
            className="cursor-pointer flex items-center gap-2  text-[#F65E53] rounded-lg transition-colors"
          >
        ...
        <div className="p-6">
          ...
          <p className="text-[#ffffff]/70 text-sm mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    />
                    <User
                      className="absolute right-4 top-1/2 transform -translate-y-1/2 text-[#ffffff]/50"
                      size={16}
                    />
                  </div>
                  {profileErrors.name && (
              ...
              <div className="md:w-1/5">
                <button
                  ...
                  className={`cursor-pointer w-full  text-black font-semibold py-3 px-4 rounded-[30px] transition-colors ${
                    profileLoading
                      ? "bg-[#6d6262ff] opacity-50 cursor-not-allowed"
                      : "bg-[#4BEEA2] hover:bg-[#3DD084]"
                  }`}
                >
