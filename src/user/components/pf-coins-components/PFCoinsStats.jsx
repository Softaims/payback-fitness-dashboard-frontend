      ...
      <div className="mb-8">
        ...
        <div className="lg:hidden">
          ...
          <div className="overflow-hidden rounded-xl bg-gradient-to-r from-[#4BEEA2] to-[#1EA264] flex flex-row items-end mb-6">
            <div className="p-4 relative overflow-hidden">
              <div className="z-10 max-w-md">
                ...
                <p className="text-sm mb-4">
                  Use purchased PF Points to join groups and create new
                  challenges
                </p>
            ...
            <div>
              <img
                src="/images/PFCoins.svg"
                className="w-[300px] h-[200px]"
                alt="PayBack Fitness Logo"
              />
            </div>
          </div>
        ...
        <div className="overflow-hidden rounded-xl bg-gradient-to-r from-[#4BEEA2] to-[#1EA264] flex flex-row items-end mb-6">
          <div className="p-4 relative overflow-hidden">
            <div className="z-10 max-w-md">
              ...
              <p className="text-sm mb-4">
                Use purchased PF Points to join groups and create new challenges
              </p>
              <button
                onClick={onPurchaseClick}
                className="cursor-pointer bg-black text-white px-6 py-3 rounded-[30px] font-semibold"
              >
                Buy PF Points
              </button>
            </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="bg-[#ffffff]/7 rounded-xl p-3">
            <div className="flex flex-col justify-between h-30">
              ...
              <div>
                <div>
                  <span className="text-3xl font-bold text-[#4BEEA2]">
                    {user?.pfCoinBalance}
                  </span>
                  <span className="text-sm ml-1 text-white">PF</span>
                </div>
                <p className="text-[#ffffff]/50 text-xs md:text-sm">
                  Available PF Points
                </p>
              </div>
            </div>
          ...
          <div className="bg-[#ffffff]/7 rounded-xl p-3">
            <div className="flex flex-col justify-between h-30">
              ...
              <div>
                <div>
                  <span className="text-3xl font-bold text-[#4BEEA2]">
                    {purchaseHistory?.totalPurchasedCoins}
                  </span>
